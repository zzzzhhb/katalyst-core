...
import (
	...
	"github.com/kubewharf/katalyst-core/pkg/metaserver/audit/sink"
...
func NewAuditManager(conf *global.AuditConfiguration, emitter metrics.MetricEmitter) *AuditManager {
	sinks := map[string]sink.Interface{}
	...
	return &AuditManager{sinks: sinks}
}
